...
MATRIX_SIZE = 5  # Size of matrices to multiply (NxN)

def test_tiny_matrix_multiplication():
    """Test a tiny matrix multiplication task on the cluster."""
    ...
    try:
        ...
        for i in range(max_polls):
            ...
            logger.info(f"Task status response: {status_info}")
...
if __name__ == "__main__":
    ...
    success = test_tiny_matrix_multiplication()
